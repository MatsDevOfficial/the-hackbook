<div class="max-w-6xl mx-auto py-12 px-6">
  <div class="mb-12">
    <h1 class="font-black text-5xl md:text-6xl flavortown-heading">Admin Dashboard</h1>
    <p
      class="text-xl text-gray-600 mt-4 font-medium uppercase tracking-widest bg-black text-white px-4 py-2 inline-block"
    >
      Control Center
    </p>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <a
      href="/admin/ships"
      class="bg-white border-4 border-black p-8 rounded-2xl shadow-[8px_8px_0px_0px_rgba(55,236,115,0.1)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] transition-all group"
    >
      <h3 class="font-black text-3xl mb-2 flavortown-heading group-hover:text-brand-green transition-colors">Ships</h3>
      <p class="text-gray-600 font-medium">Coordinate and celebrate the final ships.</p>
    </a>
  </div>
</div>
